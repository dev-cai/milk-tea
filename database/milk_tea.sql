...
(5, '柠檬汁', 10.00, 'ml', 0.10, 1.00, '新鲜柠檬汁', 4),

-- 柠檬茶 (ID: 6)
(6, '茶叶', 4.00, 'g', 0.50, 2.00, '优质绿茶', 1),
(6, '柠檬片', 3.00, '片', 0.50, 1.50, '新鲜柠檬片', 2),
(6, '蜂蜜', 20.00, 'ml', 0.08, 1.60, '天然蜂蜜', 3),
(6, '薄荷叶', 5.00, '片', 0.20, 1.00, '新鲜薄荷叶', 4),

-- 芝士奶盖茶 (ID: 7)
(7, '茶叶', 5.00, 'g', 0.50, 2.50, '优质乌龙茶', 1),
(7, '芝士粉', 30.00, 'g', 0.20, 6.00, '进口芝士粉', 2),
(7, '淡奶油', 100.00, 'ml', 0.03, 3.00, '动物性淡奶油', 3),
(7, '糖浆', 15.00, 'ml', 0.05, 0.75, '蔗糖糖浆', 4),

-- 美式咖啡 (ID: 8)
(8, '咖啡豆', 20.00, 'g', 0.80, 16.00, '优质阿拉比卡咖啡豆', 1),
(8, '热水', 300.00, 'ml', 0.001, 0.30, '纯净水', 2),

-- 拿铁咖啡 (ID: 9)
(9, '咖啡豆', 18.00, 'g', 0.80, 14.40, '优质阿拉比卡咖啡豆', 1),
...
(10, '消化饼干', 50.00, 'g', 0.02, 1.00, '消化饼干底', 2),
(10, '鸡蛋', 1.00, '个', 1.50, 1.50, '新鲜鸡蛋', 3),
(10, '细砂糖', 30.00, 'g', 0.01, 0.30, '细砂糖', 4),
(10, '香草精', 2.00, 'ml', 0.50, 1.00, '天然香草精', 5);
...
('ORD202411190005', 2, '张三', 42.00, 8.00, 34.00, 34.00, 3, 4, '加珍珠', '2024-11-19 13:45:00', '2024-11-19 13:40:00'),
...
-- 订单1的商品
(1, 1, '珍珠奶茶', '/api/uploads/images/sample/product1.jpg', 12.00, 1, 2, 1, '["珍珠"]'),
(1, 9, '拿铁咖啡', '/api/uploads/images/sample/product9.jpg', 18.00, 1, 3, 3, '[]'),

-- 订单2的商品
(2, 9, '拿铁咖啡', '/api/uploads/images/sample/product9.jpg', 18.00, 1, 3, 3, '[]'),

-- 订单3的商品
(3, 2, '波霸奶茶', '/api/uploads/images/sample/product2.jpg', 13.00, 1, 2, 2, '["波霸"]'),
(3, 9, '拿铁咖啡', '/api/uploads/images/sample/product9.jpg', 18.00, 1, 4, 3, '[]'),

-- 订单4的商品
(4, 1, '珍珠奶茶', '/api/uploads/images/sample/product1.jpg', 12.00, 1, 1, 1, '["珍珠"]'),

-- 订单5的商品
(5, 3, '红豆奶茶', '/api/uploads/images/sample/product3.jpg', 14.00, 1, 2, 2, '["红豆"]'),
(5, 7, '芝士奶盖茶', '/api/uploads/images/sample/product7.jpg', 18.00, 1, 3, 1, '["芝士奶盖"]'),
(5, 10, '芝士蛋糕', '/api/uploads/images/sample/product10.jpg', 25.00, 1, 0, 0, '[]'),

-- 订单6的商品
(6, 8, '美式咖啡', '/api/uploads/images/sample/product8.jpg', 15.00, 1, 0, 3, '[]'),

-- 订单7的商品
(7, 4, '芋泥奶茶', '/api/uploads/images/sample/product4.jpg', 15.00, 1, 2, 2, '["芋泥"]'),
(7, 6, '柠檬茶', '/api/uploads/images/sample/product6.jpg', 14.00, 1, 1, 1, '["柠檬片", "薄荷叶"]'),

-- 订单8的商品
(8, 5, '百香果茶', '/api/uploads/images/sample/product5.jpg', 16.00, 1, 2, 1, '["百香果浆"]'),
(8, 7, '芝士奶盖茶', '/api/uploads/images/sample/product7.jpg', 18.00, 1, 3, 2, '["芝士奶盖"]');
...
(1, 'ORD202411190001', 2, '张三', 22.00, '商品质量问题，奶茶味道不对', 0, NULL, NULL, '2024-11-19 10:30:00'),
(3, 'ORD202411190003', 2, '张三', 26.00, '等待时间太长，不想要了', 0, NULL, NULL, '2024-11-19 12:00:00'),
(5, 'ORD202411190005', 2, '张三', 34.00, '配料不新鲜', 1, NULL, '2024-11-19 14:30:00', '2024-11-19 14:00:00'),
(8, 'ORD202411190008', 3, '李四', 30.00, '口味不符合预期', 2, '订单已完成且超过退款时限', '2024-11-19 17:00:00', '2024-11-19 16:45:00'),
...
(1, 'ORD202411190001', 2, '张三', 1, '奶茶里面有异物，怀疑是制作过程中混入的杂质，希望能够重视食品安全问题', NULL, 0, NULL, NULL, '2024-11-19 10:00:00'),
(2, 'ORD202411190002', 3, '李四', 2, '店员态度很差，说话不礼貌，服务态度需要改进', NULL, 1, '非常抱歉给您带来不好的体验，我们已经对相关员工进行了培训', '2024-11-19 11:00:00', '2024-11-19 10:30:00'),
...
(7, 'ORD202411190007', 2, '张三', 4, '包装破损，奶茶洒了一半', NULL, 3, '已为您重新制作并配送，同时赠送了小食作为补偿', '2024-11-19 15:45:00', '2024-11-19 15:30:00'),
(8, 'ORD202411190008', 3, '李四', 1, '芝士奶盖不新鲜，有异味', NULL, 0, NULL, NULL, '2024-11-19 16:50:00');
...
-- 插入钻石会员
INSERT INTO `user` (`username`, `password`, `nickname`, `phone`, `member_level`, `points`, `balance`, `user_type`, `status`, `create_time`, `last_login_time`) VALUES
('svip1', 'e10adc3949ba59abbe56e057f20f883e', 'SVIP张总', '12800128000', 2, 2500, 500.00, 0, 1, '2024-09-01 10:00:00', '2024-11-19 09:00:00'),
('svip2', 'e10adc3949ba59abbe56e057f20f883e', 'SVIP李总', '12700127000', 2, 2200, 450.00, 0, 1, '2024-09-15 14:00:00', '2024-11-19 11:30:00'),
('svip3', 'e10adc3949ba59abbe56e057f20f883e', 'SVIP王总', '12600126000', 2, 1800, 380.00, 0, 1, '2024-10-01 16:00:00', '2024-11-18 15:00:00');

-- 插入今日新增用户
INSERT INTO `user` (`username`, `password`, `nickname`, `phone`, `member_level`, `points`, `balance`, `user_type`, `status`, `create_time`) VALUES
('newuser1', 'e10adc3949ba59abbe56e057f20f883e', '新用户1', '12500125000', 0, 0, 0.00, 0, 1, NOW()),
('newuser2', 'e10adc3949ba59abbe56e057f20f883e', '新用户2', '12400124000', 0, 0, 0.00, 0, 1, NOW()),
('newuser3', 'e10adc3949ba59abbe56e057f20f883e', '新用户3', '12300123000', 0, 0, 0.00, 0, 1, NOW());
...
-- VIP用户的订单
INSERT INTO `orders` (`order_no`, `user_id`, `username`, `total_amount`, `discount_amount`, `pay_amount`, `actual_amount`, `pay_type`, `status`, `pay_time`, `finish_time`, `create_time`) VALUES
-- vip1的订单
('ORD202411150001', 7, 'VIP张三', 45.00, 5.00, 40.00, 40.00, 1, 4, '2024-11-15 10:30:00', '2024-11-15 11:00:00', '2024-11-15 10:25:00'),
...
-- vip2的订单
('ORD202411140001', 8, 'VIP李四', 35.00, 3.00, 32.00, 32.00, 1, 4, '2024-11-14 15:00:00', '2024-11-14 15:30:00', '2024-11-14 14:55:00'),
...
-- svip1的订单（钻石会员，消费更多）
('ORD202411130001', 11, 'SVIP张总', 88.00, 10.00, 78.00, 78.00, 1, 4, '2024-11-13 12:00:00', '2024-11-13 12:30:00', '2024-11-13 11:55:00'),
('ORD202411140002', 11, 'SVIP张总', 95.00, 12.00, 83.00, 83.00, 1, 4, '2024-11-14 14:30:00', '2024-11-14 15:00:00', '2024-11-14 14:25:00'),
('ORD202411150002', 11, 'SVIP张总', 102.00, 15.00, 87.00, 87.00, 2, 4, '2024-11-15 16:00:00', '2024-11-15 16:30:00', '2024-11-15 15:55:00'),
('ORD202411160003', 11, 'SVIP张总', 78.00, 8.00, 70.00, 70.00, 1, 4, '2024-11-16 11:20:00', '2024-11-16 11:50:00', '2024-11-16 11:15:00'),
('ORD202411170003', 11, 'SVIP张总', 92.00, 10.00, 82.00, 82.00, 1, 4, '2024-11-17 13:40:00', '2024-11-17 14:10:00', '2024-11-17 13:35:00'),
('ORD202411180005', 11, 'SVIP张总', 85.00, 9.00, 76.00, 76.00, 2, 4, '2024-11-18 15:20:00', '2024-11-18 15:50:00', '2024-11-18 15:15:00'),
...
(11, 7, '芝士奶盖茶', '/api/uploads/images/sample/product7.jpg', 18.00, 2, 3, 1, '["芝士奶盖"]'),
...
-- svip1的订单明细
INSERT INTO `order_item` (`order_id`, `product_id`, `product_name`, `product_image`, `price`, `quantity`, `sweetness`, `temperature`, `toppings`) VALUES
(13, 7, '芝士奶盖茶', '/api/uploads/images/sample/product7.jpg', 18.00, 3, 3, 1, '["芝士奶盖"]'),
...
SELECT CONCAT('普通会员: ', COUNT(*)) AS normal_count FROM user WHERE member_level = 0;
...
('双11狂欢节', 'discount', '全场满50减10，满100减25', '活动期间，单笔订单满50元减10元，满100元减25元', '/images/activity1.jpg', '2024-11-11 00:00:00', '2024-11-11 23:59:59', 580, 15600.00, 2),
('新品秒杀', 'seckill', '新品限时秒杀，每日10点开抢', '每日10:00-12:00，指定新品5折秒杀，限量100份', '/images/activity2.jpg', '2024-11-15 00:00:00', '2024-11-30 23:59:59', 320, 8900.00, 1),
('买一送一', 'gift', '指定商品买一送一', '购买指定商品，赠送同款商品一份', '/images/activity3.jpg', '2024-11-20 00:00:00', '2024-11-25 23:59:59', 180, 5200.00, 1),
('会员日', 'member', '会员专享8折优惠', '每周三会员日，全场商品会员8折', '/images/activity4.jpg', '2024-11-01 00:00:00', '2024-12-31 23:59:59', 450, 12800.00, 1),
('圣诞特惠', 'discount', '圣诞节满减活动', '圣诞节期间，满88减18，满128减38', '/images/activity5.jpg', '2024-12-24 00:00:00', '2024-12-26 23:59:59', 0, 0.00, 0);
...
('前台打印机', 'thermal', 'network', '192.168.1.100', 9100, 1, '前台收银打印机，用于打印订单小票'),
('厨房打印机', 'thermal', 'network', '192.168.1.101', 9100, 1, '厨房订单打印机，用于打印制作单'),
('备用打印机', 'thermal', 'network', '192.168.1.102', 9100, 0, '备用打印机，离线状态');
...
(4, 3, 1, 2, 1, 0, 1, '2024-11-19 12:01:00', '设备离线，无法连接');
...
('manager01', MD5('123456'), '李四', '13800138002', 'lisi@milktea.com', 'EMP002', 'manager', 'management', '2023-03-20', 8000.00, '北京市海淀区', '["dashboard.view","product.view","product.edit","order.view","order.process","user.view"]', 1, DATE_SUB(NOW(), INTERVAL 1 DAY)),
...
('maker02', MD5('123456'), '周八', '13800138006', 'zhouba@milktea.com', 'EMP006', 'maker', 'kitchen', '2023-09-20', 5200.00, '北京市石景山区', '["order.view","product.view"]', 0, DATE_SUB(NOW(), INTERVAL 30 DAY));
...
('总店', '北京市朝阳区建国路88号', '010-12345678', '张三', '13800138001', '["09:00","22:00"]', 39.904989, 116.407526, 150.00, 15, '总店位于市中心，交通便利，环境优雅', 1),
('海淀分店', '北京市海淀区中关村大街1号', '010-23456789', '李四', '13800138002', '["09:00","22:00"]', 39.983424, 116.318977, 120.00, 10, '位于中关村核心区域，科技氛围浓厚', 1),
('西城分店', '北京市西城区西单北大街120号', '010-34567890', '王五', '13800138003', '["10:00","21:00"]', 39.913418, 116.374328, 100.00, 8, '西单商圈黄金位置，客流量大', 1),
('东城分店', '北京市东城区王府井大街138号', '010-45678901', '赵六', '13800138004', '["09:30","21:30"]', 39.909187, 116.416357, 130.00, 12, '王府井步行街旁，游客众多', 1),
('丰台分店', '北京市丰台区丰台路100号', '010-56789012', '孙七', '13800138005', '["09:00","22:00"]', 39.858427, 116.287123, 110.00, 9, '丰台区域中心店，服务周边社区', 0);
...
('shop_address', '北京市朝阳区建国路88号', '联系地址', 1),

-- 支付配置
('payment_wechat_enabled', 'true', '微信支付开关', 3),
('payment_alipay_enabled', 'false', '支付宝支付开关', 3),
('payment_balance_enabled', 'true', '余额支付开关', 3),
...
-- 积分规则
('points_earn_rate', '1.0', '消费获取积分比例（消费1元获得积分）', 2),
('points_redeem_rate', '1.0', '积分抵扣比例（100积分可抵扣金额）', 2),
('points_min_redeem', '100', '最低抵扣积分', 2),
